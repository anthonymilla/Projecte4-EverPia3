...
A continuació, caldrà que hi treballeu els aspectes del tema mitjançant una dinàmica cooperativa.
...
- **10 Equips Clients (Windows 10/11):** Els usuaris treballen majoritàriament amb fitxers del servidor, però alguns tècnics guarden temporalment informes i altres arxius importants.
...
- Separar **Servidor/Clients** i **crítiques/no crítiques**.
...
- **Mitjà 2 (Extern):** Quin mitjà (p. ex., Cloud, LTO) i el proveïdor proposat (Azure, Google Cloud, servei local).  

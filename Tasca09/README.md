...
Tenen un problema crític: el seu codi font i els seus actius (documents de disseny, scripts) estan descontrolats. Cada desenvolupador té còpies locals, cosa que provoca errors de versió constants i una pèrdua d'eficiència brutal.  
...
- Crearàs un **servidor NFS (NFSv3)** i un **client Linux** que consumeixi els recursos compartits.  
- Hauràs de crear **usuaris i grups** per simular l'entorn del client.  
- Demostraràs el **control d'accés** utilitzant:
...
[Anar a la solució](../Tasca09/Guia.md)     

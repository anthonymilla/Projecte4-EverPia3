...
Després de setmanes convivint amb el ritme imprevisible d’una consultora tecnològica, arriba al darrer capítol de la trilogia **EverPia**.  
És un moment que combina entusiasme, maduresa i una sensació molt real: aquesta etapa s’acaba, i comença alguna cosa nova.

## La trajectòria professional a les consultores
...
- De sobte et veus apagant incendis.  
...
- Aprenent a una velocitat que no apareix a cap manual.

Aquesta intensitat et fa créixer.  
Aquesta pressió et defineix.  
Aquesta experiència accelerada et converteix en professional.  

Un dia, sense adonar-te’n, descobreixes que ja no ets el mateix júnior que va entrar per la porta amb por i il·lusió.  
Ara tens eines, criteri, documentació pròpia i una manera de mirar els problemes que només es guanya treballant molt i en silenci.
...
- Com afronta reptes complexos sense perdre el nord  

No és un conjunt de tasques. És la seva **carta de presentació professional**.

## El final de les pràctiques
Ja saps que et trobes a les últimes setmanes a EverPia.  
I precisament per això vols acabar per la porta gran: demostrant que domines allò que fa uns mesos et semblava impossible, validant la teva capacitat de treball en equip i executant tasques que requereixen una mirada madura i professional.  
...
4. **Consolidar competències de disseny digital**  
   - Prototipatge funcional en Figma, preparant la base d’un futur ecommerce.
...
- [Tasca1-DRP: còpies de seguretat. Estudi cas client](/Tasca01)
- [Tasca2-DPR: còpies de seguretat. Cas pràctic](/Tasca02)
- [Tasca3-Pla de recuperació davant desastres: imatges del sistema](/Tasca03)
- [Tasca4-Accés remot](/Tasca04)
- [Tasca5-Accés Remot. Connexió via SSH](/Tasca05)
- [Tasca6-Accés remot. Escriptori remot (RDP)](/Tasca06)
- [Tasca7-Accés remot. Serveis d’assistència remota](/Tasca07)
- [Tasca8-Auditoria de Qualitat i Estandardització de Servidors](/Tasca08)
- [Tasca9-Servidor fitxers Linux. NFS](/Tasca09)
...
## Productes
- [Producte1-GitHub. Treballant de forma col·laborativa: forks i pull request.](/Producte01)
